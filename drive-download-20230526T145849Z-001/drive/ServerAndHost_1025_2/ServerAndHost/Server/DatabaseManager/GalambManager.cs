    ...
    public class GalambManager:BaseDatabaseManager,ISQL
    {
        ...
        public int Insert(Record record)
        {
           Galamb galamb = record as Galamb;
            ...
            if (hozzaadottSorokSzama > 0)
            {
                hibaUzenet = "Új galamb sikeresen hozzáadva!";
            }
            else
            {
                hibaUzenet = "Nem sikerült új galambot hozzáadni.";
            }
        ...
        public int Update(Record record)
        {
            ...
            {
                hibaUzenet = $"Galamb (ID:{galamb.ID}) sikeresen módosítva!";
            }
            else
            {
        ...
        public int Delete(int id)
        {
            ...
            if (toroltSorokSzama > 0)
            {
                hibaUzenet = $"Galamb (ID:{id}) sikeresen törölve!";
            }
            else
            {
                hibaUzenet = "Nem történt törlés.";
            }
