...
export function ProductSinglePage(props) {
            ...
            {isPending || !product.Id ? (
                <div className="spinner-border"></div>
                            ...
                            <div className="card p-3">
                                ...
                                <div className="lead">Ár: {product.Price}</div>
                                <div className="lead">Mennyiség: {product.Qty}</div>
                                    <img alt={product.Name}
                                    className="img-fluid rounded"
                                    style={{maxHeight: "500px"}}
                                    src={product.Flagimg ? product.Flagimg : 
...
<NavLink key="y" to={"/mod-product/" + product.Id}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
