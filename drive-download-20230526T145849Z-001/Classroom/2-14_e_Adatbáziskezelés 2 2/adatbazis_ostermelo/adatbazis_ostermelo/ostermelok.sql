...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Sze 29. 18:49
...
CREATE TABLE `gyumolcslevek` (
  `id` int(11) NOT NULL,
  `gynev` varchar(16) COLLATE utf8mb4_hungarian_ci NOT NULL
...
CREATE TABLE `partnerek` (
  `id` int(11) NOT NULL,
  `kontakt` varchar(20) COLLATE utf8mb4_hungarian_ci NOT NULL,
